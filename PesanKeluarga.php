...
<table width="987" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="558" height="40" bgcolor="#00B2B4"><a href="bantuan.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','img/button/bantuan copy.PNG',1)"><img src="img/button/bantuan.png" name="Image7" width="113" height="25" id="Image7" /></a></td>
    ...
    <td height="400" colspan="8" bgcolor="#363636"><table width="981" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="973" height="50" bgcolor="#FFCC2A"><table width="973" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="967" height="800" bgcolor="#363636"><table width="967" border="0" cellspacing="8" cellpadding="0">
              <tr>
                <td width="935"><img src="img/mobil_pribadi/HASIL PENCARIAN.PNG" width="950" height="79" /></td>
                </tr>
            </table>
 ...
 <?php
	...
	$sql  = "SELECT * FROM tb_keluarga WHERE kota_asal='$kota_asal' and kota_tujuan='$kota_tujuan'";
	$rest = mysqli_query($con, $sql);
	while($data=mysqli_fetch_array($rest))
	{
?>
                <tr>
                  <td width="315" height="204"><img src="img/mobil_pribadi/<?php echo $data['gambar'];?>" alt="" width="315" height="204" /></td>
                  <td width="290"><table width="291" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="20"><h3>Biaya</h3></td>
                      <td><h3><?php echo $data['harga'];?></h3></td>
                    </tr>
                    <tr>
                      <td height="40" colspan="2"><table width="438" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="270" height="20"><h3>Paket</h3></td>
                          <td width="168"><h3><?php echo $data['paket'];?></h3></td>
                        </tr>
                        <tr>
                          <td height="20"><h3>Kapasitas Penumpang</h3></td>
                          <td><h3><?php echo $data['kapasitas'];?></h3></td>
                        </tr>
                        <tr>
                          <td height="40">&nbsp;</td>
                          <td><a href="Pendaftaran.php?id=<?php echo $data['gambar'];?>" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','img/button/PESAN2.png',1)">
