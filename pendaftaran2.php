...
<body onload="MM_preloadImages('img/button/nyater copy.PNG','img/button/travel copy.png','img/button/tentang copy.PNG','img/button/bantuan copy.PNG','img/button/CARI2.PNG','img/button/KEMBALI2.png','img/button/Daftarfix2.png')">
 ...
 <?php
	...
	$sql  = "SELECT * FROM tb_pariwisata WHERE gambar='$gambar'";
...
<table width="981" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="214" height="40" bgcolor="#00B2B4"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','img/button/bantuan copy.PNG',1)"><img src="img/button/bantuan.png" name="Image7" width="113" height="25" id="Image7" /></a></td>
    ...
    <td colspan="8" bgcolor="#FFCC2A"><table width="981" border="0" cellspacing="4" cellpadding="0">
      <tr>
        <td bgcolor="#363636"><table width="967" border="0" cellspacing="20" cellpadding="0">
          ...
          <tr>
            <td height="434"><form action="simpan2.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="925" border="0" align="left" cellpadding="0" cellspacing="13">
                <tr>
                  <td width="129">Kota Asal</td>
                  <td width="311"><label for="txt_tanggal"></label>
                  ...
                  <td width="433" rowspan="13"><table width="433" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><img src="img/button/SYARAT2.PNG" alt="" width="433" height="249" /></td>
                    </tr>
                    <tr>
                ...
                <tr>
                  <td width="129">Kota Tujuan</td>
                  <td width="311"><input name="txt_kota_tujuan" type="text" id="textfield2" value="<?php echo $data['kota_tujuan']; ?>" size="30" readonly="readonly" /></td>
                </tr>
                <tr>
                  <td width="129">Paket</td>
                  <td width="311"><label for="txt_paket"></label>
                    <input name="txt_paket" type="text" id="txt_paket" value="<?php echo $data['paket']; ?>"size="30" readonly="readonly" /></td>
                </tr>
                <tr>
                  <td width="129">Kapasitas Bus</td>
                  <td width="311"><input name="txt_kapasitas_bus" type="text" id="textfield3" value="<?php echo $data['kapasitas']; ?>" size="1" readonly="readonly" />
                    Orang / Jumlah Bus
                    <select name="txt_jumlah_bus" id="txt_jumlah_bus">
                ...
                <tr>
                  <td width="129">Jenis Pesanan</td>
                  <td width="311"><label for="select4"></label>
                    <select name="txt_jenis_pesananan" id="select4">
                      <option value="Personal">Personal</option>
                      <option value="Grub">Grub</option>
                    </select>
                    <label for="txt_nama_perwakilan"></label>
                    <input name="txt_nama_pesanan" type="text" id="txt_nama_perwakilan" placeholder="Instansi/Perwakilan" size="16"/></td>
                </tr>
                <tr>
                  <td width="129">Alamat</td>
                  <td width="311"><textarea name="txt_alamat" cols="28" id="textfield4"></textarea></td>
                </tr>
                <tr>
                  <td width="129">Lama Sewa</td>
                  <td width="311"><label for="txt_lama_sewa"></label>
                    <select name="txt_lama_sewa" id="txt_lama_sewa">
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
                      <option value="4">4</option>
...
<label for="textfield3"></label>
                ...
                <tr>
                  <td width="129">Tanggal Jemput</td>
                  <td width="311"><input type="date" name="txt_tanggal" id="textfield8" size="8"/>
                    <label for="select5"></label></td>
                </tr>
                <tr>
                  <td width="129">Waktu Jemput</td>
                  <td width="311"><select name="txt_waktu" id="select5">
                ...
                <tr>
                  ...
                  <td width="311"><input name="txt_email" type="text" id="textfield5" size="31" /></td>
                </tr>
                <tr>
                  <td width="129">No.Telepon</td>
                  <td width="311"><input name="txt_no_telepon" type="text" id="textfield6" size="31" /></td>
                </tr>
                <tr>
                  <td width="129" height="40">&nbsp;</td>
                  <td width="311" height="40"><table width="228" border="0" cellspacing="5" cellpadding="0">
                    <tr>
                      <td width="101" height="30"><a href="pariwisata.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','img/button/KEMBALI2.png',1)"><img src="img/button/KEMBALI.png" alt="" name="Image9" width="99" height="40" id="Image9" /></a></td>
                      <td width="112" height="30"></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','img/button/Daftarfix2.png',1)"><input type="image" img src="img/button/Daftarfix1.png" name="Image11" width="99" height="40" id="Image11" alt="submit button" /></a></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
